...
import com.winlator.cmod.gog.api.DepotFile
import com.winlator.cmod.gog.api.FileChunk
import com.winlator.cmod.gog.api.GOGApiClient
import com.winlator.cmod.gog.api.GOGManifestMeta
import com.winlator.cmod.gog.api.GOGManifestParser
import com.winlator.cmod.gog.api.V1DepotFile
...
class GOGDownloadManager @Inject constructor(
    ...
    suspend fun downloadGame(
        ...
        try {
            ...
            com.winlator.cmod.PluviaApp.events.emitJava(
                com.winlator.cmod.steam.events.AndroidEvent.DownloadStatusChanged(gameId.toIntOrNull() ?: 0, true),
            )
            ...
            com.winlator.cmod.PluviaApp.events.emitJava(
                com.winlator.cmod.steam.events.AndroidEvent.DownloadStatusChanged(gameId.toIntOrNull() ?: 0, false),
            )
    ...
    private suspend fun finalizeInstallSuccess(gameId: String, installPath: File, downloadInfo: DownloadInfo) {
        ...
        com.winlator.cmod.PluviaApp.events.emitJava(
            com.winlator.cmod.steam.events.AndroidEvent.LibraryInstallStatusChanged(gameId.toIntOrNull() ?: 0),
        )
    }
    ...
    private suspend fun downloadGameGen1(
        ...
        installPath: File,
        downloadInfo: DownloadInfo,
        gameManifest: com.winlator.cmod.gog.api.GOGManifestMeta,
        selectedBuild: com.winlator.cmod.gog.api.GOGBuild,
        language: String,
        withDlcs: Boolean,
        supportDir: File?,
    ): Result<Unit> = withContext(Dispatchers.IO) {
