...
import com.winlator.cmod.epic.service.manifest.ManifestUtils
...
class EpicDownloadManager @Inject constructor(
    ...
    suspend fun downloadGame(
        ...
        try {
            ...
            com.winlator.cmod.PluviaApp.events.emitJava(
                com.winlator.cmod.steam.events.AndroidEvent.DownloadStatusChanged(gameId, true),
            )
            ...
            com.winlator.cmod.PluviaApp.events.emitJava(
                com.winlator.cmod.steam.events.AndroidEvent.LibraryInstallStatusChanged(gameId),
            )
            ...
            com.winlator.cmod.PluviaApp.events.emitJava(
                com.winlator.cmod.steam.events.AndroidEvent.DownloadStatusChanged(gameId, false),
            )
        }
    }
    ...
    private suspend fun downloadChunkWithRetry(
        chunk: com.winlator.cmod.epic.service.manifest.ChunkInfo,
        chunkCacheDir: File,
        chunkDir: String,
    ...
    private suspend fun assembleFile(
        fileManifest: com.winlator.cmod.epic.service.manifest.FileManifest,
        chunkCacheDir: File,
        installDir: File,
    ): Result<File> = withContext(Dispatchers.IO) {
        try {
