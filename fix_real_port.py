...
def fix_file(path):
    ...
    # Stub out specific high-level services that are hard to port
    content = re.sub(r'import com\.winlator\.cmod\.steam\.utils\.NetworkMonitor', '', content)
    content = re.sub(r'import com\.winlator\.cmod\.steam\.utils\.BestConfigService', '', content)
    content = re.sub(r'import com\.winlator\.cmod\.steam\.utils\.SupportersUtils', '', content)
    content = re.sub(r'import com\.winlator\.cmod\.steam\.utils\.UpdateChecker', '', content)
    content = re.sub(r'import com\.winlator\.cmod\.steam\.utils\.GameFeedbackUtils', '', content)
